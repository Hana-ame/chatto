...
const msg_bots_nav = (): LocalizedString => messages().bots_nav(empty());
const msg_bots_settings_page_title = (): LocalizedString => messages().bots_settings_page_title(empty());
const msg_bots_settings_title = (): LocalizedString => messages().bots_settings_title(empty());
const msg_bots_settings_subtitle = (): LocalizedString => messages().bots_settings_subtitle(empty());
const msg_bots_admin_title = (): LocalizedString => messages().bots_admin_title(empty());
const msg_bots_admin_subtitle = (): LocalizedString => messages().bots_admin_subtitle(empty());
const msg_bots_unavailable_owner = (): LocalizedString => messages().bots_unavailable_owner(empty());
const msg_bots_loading = (): LocalizedString => messages().bots_loading(empty());
const msg_bots_loading_more = (): LocalizedString => messages().bots_loading_more(empty());
const msg_bots_list_title = (): LocalizedString => messages().bots_list_title(empty());
const msg_bots_empty_title = (): LocalizedString => messages().bots_empty_title(empty());
const msg_bots_empty_owner = (): LocalizedString => messages().bots_empty_owner(empty());
const msg_bots_empty_admin = (): LocalizedString => messages().bots_empty_admin(empty());
const msg_bots_badge_bot = (): LocalizedString => messages().bots_badge_bot(empty());
const msg_bots_field_bot = (): LocalizedString => messages().bots_field_bot(empty());
const msg_bots_field_owner = (): LocalizedString => messages().bots_field_owner(empty());
const msg_bots_field_display_name = (): LocalizedString => messages().bots_field_display_name(empty());
const msg_bots_field_username = (): LocalizedString => messages().bots_field_username(empty());
const msg_bots_field_description = (): LocalizedString => messages().bots_field_description(empty());
const msg_bots_field_api_key = (): LocalizedString => messages().bots_field_api_key(empty());
const msg_bots_placeholder_display_name = (): LocalizedString => messages().bots_placeholder_display_name(empty());
const msg_bots_placeholder_username = (): LocalizedString => messages().bots_placeholder_username(empty());
const msg_bots_placeholder_description = (): LocalizedString => messages().bots_placeholder_description(empty());
const msg_bots_help_username = (): LocalizedString => messages().bots_help_username(empty());
const msg_bots_help_description = (): LocalizedString => messages().bots_help_description(empty());
const msg_bots_credentials_title = (
  inputs: Parameters<LocaleMessages['bots_credentials_title']>[0]
): LocalizedString => messages().bots_credentials_title(inputs);
const msg_bots_credentials_active_description = (): LocalizedString => messages().bots_credentials_active_description(empty());
const msg_bots_credentials_none_description = (): LocalizedString => messages().bots_credentials_none_description(empty());
const msg_bots_credentials_generate = (): LocalizedString => messages().bots_credentials_generate(empty());
const msg_bots_credentials_rotate = (): LocalizedString => messages().bots_credentials_rotate(empty());
const msg_bots_credentials_revoke = (): LocalizedString => messages().bots_credentials_revoke(empty());
const msg_bots_credentials_copy = (): LocalizedString => messages().bots_credentials_copy(empty());
const msg_bots_credentials_show_once = (): LocalizedString => messages().bots_credentials_show_once(empty());
const msg_bots_credentials_generate_confirm_title = (): LocalizedString => messages().bots_credentials_generate_confirm_title(empty());
const msg_bots_credentials_generate_confirm_body = (): LocalizedString => messages().bots_credentials_generate_confirm_body(empty());
const msg_bots_credentials_rotate_confirm_title = (): LocalizedString => messages().bots_credentials_rotate_confirm_title(empty());
const msg_bots_credentials_rotate_confirm_body = (): LocalizedString => messages().bots_credentials_rotate_confirm_body(empty());
const msg_bots_credentials_revoke_confirm_title = (): LocalizedString => messages().bots_credentials_revoke_confirm_title(empty());
const msg_bots_credentials_revoke_confirm_body = (): LocalizedString => messages().bots_credentials_revoke_confirm_body(empty());
const msg_bots_credentials_copy_failed = (): LocalizedString => messages().bots_credentials_copy_failed(empty());
const msg_bots_credentials_toast_rotated = (): LocalizedString => messages().bots_credentials_toast_rotated(empty());
const msg_bots_credentials_toast_revoked = (): LocalizedString => messages().bots_credentials_toast_revoked(empty());
const msg_bots_api_key_active = (): LocalizedString => messages().bots_api_key_active(empty());
const msg_bots_api_key_none = (): LocalizedString => messages().bots_api_key_none(empty());
const msg_bots_dialog_create_title = (): LocalizedString => messages().bots_dialog_create_title(empty());
const msg_bots_dialog_edit_title = (): LocalizedString => messages().bots_dialog_edit_title(empty());
const msg_bots_dialog_description = (): LocalizedString => messages().bots_dialog_description(empty());
const msg_bots_action_create = (): LocalizedString => messages().bots_action_create(empty());
const msg_bots_action_creating = (): LocalizedString => messages().bots_action_creating(empty());
const msg_bots_action_save = (): LocalizedString => messages().bots_action_save(empty());
const msg_bots_action_saving = (): LocalizedString => messages().bots_action_saving(empty());
const msg_bots_toast_created = (): LocalizedString => messages().bots_toast_created(empty());
const msg_bots_toast_updated = (): LocalizedString => messages().bots_toast_updated(empty());
const msg_bots_error_username_suffix = (): LocalizedString => messages().bots_error_username_suffix(empty());
const msg_bots_error_save_failed = (): LocalizedString => messages().bots_error_save_failed(empty());
...
export { msg_bots_nav as 'bots.nav' };
export { msg_bots_settings_page_title as 'bots.settings.page_title' };
export { msg_bots_settings_title as 'bots.settings.title' };
export { msg_bots_settings_subtitle as 'bots.settings.subtitle' };
export { msg_bots_admin_title as 'bots.admin.title' };
export { msg_bots_admin_subtitle as 'bots.admin.subtitle' };
export { msg_bots_unavailable_owner as 'bots.unavailable.owner' };
export { msg_bots_loading as 'bots.loading' };
export { msg_bots_loading_more as 'bots.loading_more' };
export { msg_bots_list_title as 'bots.list.title' };
export { msg_bots_empty_title as 'bots.empty.title' };
export { msg_bots_empty_owner as 'bots.empty.owner' };
export { msg_bots_empty_admin as 'bots.empty.admin' };
export { msg_bots_badge_bot as 'bots.badge.bot' };
export { msg_bots_field_bot as 'bots.field.bot' };
export { msg_bots_field_owner as 'bots.field.owner' };
export { msg_bots_field_display_name as 'bots.field.display_name' };
export { msg_bots_field_username as 'bots.field.username' };
export { msg_bots_field_description as 'bots.field.description' };
export { msg_bots_field_api_key as 'bots.field.api_key' };
export { msg_bots_placeholder_display_name as 'bots.placeholder.display_name' };
export { msg_bots_placeholder_username as 'bots.placeholder.username' };
export { msg_bots_placeholder_description as 'bots.placeholder.description' };
export { msg_bots_help_username as 'bots.help.username' };
export { msg_bots_help_description as 'bots.help.description' };
export { msg_bots_credentials_title as 'bots.credentials.title' };
export { msg_bots_credentials_active_description as 'bots.credentials.active_description' };
export { msg_bots_credentials_none_description as 'bots.credentials.none_description' };
export { msg_bots_credentials_generate as 'bots.credentials.generate' };
export { msg_bots_credentials_rotate as 'bots.credentials.rotate' };
export { msg_bots_credentials_revoke as 'bots.credentials.revoke' };
export { msg_bots_credentials_copy as 'bots.credentials.copy' };
export { msg_bots_credentials_show_once as 'bots.credentials.show_once' };
export { msg_bots_credentials_generate_confirm_title as 'bots.credentials.generate_confirm_title' };
export { msg_bots_credentials_generate_confirm_body as 'bots.credentials.generate_confirm_body' };
export { msg_bots_credentials_rotate_confirm_title as 'bots.credentials.rotate_confirm_title' };
export { msg_bots_credentials_rotate_confirm_body as 'bots.credentials.rotate_confirm_body' };
export { msg_bots_credentials_revoke_confirm_title as 'bots.credentials.revoke_confirm_title' };
export { msg_bots_credentials_revoke_confirm_body as 'bots.credentials.revoke_confirm_body' };
export { msg_bots_credentials_copy_failed as 'bots.credentials.copy_failed' };
export { msg_bots_credentials_toast_rotated as 'bots.credentials.toast.rotated' };
export { msg_bots_credentials_toast_revoked as 'bots.credentials.toast.revoked' };
export { msg_bots_api_key_active as 'bots.api_key.active' };
export { msg_bots_api_key_none as 'bots.api_key.none' };
export { msg_bots_dialog_create_title as 'bots.dialog.create_title' };
export { msg_bots_dialog_edit_title as 'bots.dialog.edit_title' };
export { msg_bots_dialog_description as 'bots.dialog.description' };
export { msg_bots_action_create as 'bots.action.create' };
export { msg_bots_action_creating as 'bots.action.creating' };
export { msg_bots_action_save as 'bots.action.save' };
export { msg_bots_action_saving as 'bots.action.saving' };
export { msg_bots_toast_created as 'bots.toast.created' };
export { msg_bots_toast_updated as 'bots.toast.updated' };
export { msg_bots_error_username_suffix as 'bots.error.username_suffix' };
export { msg_bots_error_save_failed as 'bots.error.save_failed' };
