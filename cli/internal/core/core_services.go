...
func assembleCore(
	...
	return &ChattoCore{
		...
		RoomBans:              projections.roomDirectory.Bans,
		...
		RoomTimelineProjector: projections.roomTimelineProjector,
		CallState:             projections.callState,
		CallStateProjector:    projections.callStateProjector,
